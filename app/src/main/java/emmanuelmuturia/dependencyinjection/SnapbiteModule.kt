...
import emmanuelmuturia.food.ui.EditFoodScreenViewModel
...
val snapbiteModule = module {
    ...
    viewModel { (application: Application) -> EditFoodScreenViewModel(application, get()) }
    ...
    viewModel { (application: Application) -> DayScreenViewModel(application, get()) }
